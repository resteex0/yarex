...
rule resteex_CryptBot {
	...
	strings:
		 ...
		 $s17= "f:ddvctoolscrt_bldself_x86crtsrcfeoferr.c" fullword wide
		 ...
		 $s29= "f:ddvctoolscrt_bldself_x86crtsrcmalloc.h" fullword wide
		 ...
		 $s35= "f:ddvctoolscrt_bldself_x86crtsrcprintf.c" fullword wide
		 $s36= "f:ddvctoolscrt_bldself_x86crtsrcread.c" fullword wide
		 $s37= "f:ddvctoolscrt_bldself_x86crtsrcscanf.c" fullword wide
		 $s38= "f:ddvctoolscrt_bldself_x86crtsrcsetlocal.c" fullword wide
		 $s39= "f:ddvctoolscrt_bldself_x86crtsrc_sftbuf.c" fullword wide
		 $s40= "f:ddvctoolscrt_bldself_x86crtsrcstdenvp.c" fullword wide
		 $s41= "f:ddvctoolscrt_bldself_x86crtsrcstrtol.c" fullword wide
		 $s42= "f:ddvctoolscrt_bldself_x86crtsrcstrtoq.c" fullword wide
		 ...
		 $s46= "f:ddvctoolscrt_bldself_x86crtsrcungetc_nolock.inl" fullword wide
		 $s47= "f:ddvctoolscrt_bldself_x86crtsrcvsprintf.c" fullword wide
		 $s48= "f:ddvctoolscrt_bldself_x86crtsrcvswprint.c" fullword wide
		 $s49= "f:ddvctoolscrt_bldself_x86crtsrcwcstombs.c" fullword wide
		 $s50= "f:ddvctoolscrt_bldself_x86crtsrcwctomb.c" fullword wide
		 $s51= "f:ddvctoolscrt_bldself_x86crtsrcwinsig.c" fullword wide
		 $s52= "f:ddvctoolscrt_bldself_x86crtsrcwrite.c" fullword wide
		 $s53= "f:ddvctoolscrt_bldself_x86crtsrcxtoa.c" fullword wide
		 $s54= "gekupamasusa tozidehiyuyafahepahuxocarebayay" fullword wide
		 $s55= "levihufanogisojinasitogatopacaxuhozuwehu" fullword wide
		 $s56= "verosiwagasedavijozegulozakeawkutafojajocoxelufayifelif" fullword wide
		 ...
		 $hex60= {247335343d20226765}
		 $hex61= {247335353d20226c65}
		 $hex62= {247335363d20227665}
		 $hex63= {2473353d2022663a64}
		 $hex64= {2473363d2022663a64}
		 $hex65= {2473373d2022663a64}
		 $hex66= {2473383d2022663a64}
		 $hex67= {2473393d2022663a64}
