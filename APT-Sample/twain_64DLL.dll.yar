...
/*
   YARA Rule Set
   Author: resteex
   Identifier: APT_Sample_APT28_twain_64DLL_dll 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_APT_Sample_APT28_twain_64DLL_dll {
	meta: 
		 description= "APT_Sample_APT28_twain_64DLL_dll Group" 
		 author = "Resteex Generator" 
		 date = "2022-04-26_03-22-07" 
