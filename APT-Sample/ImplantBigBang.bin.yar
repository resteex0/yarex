...
/*
   YARA Rule Set
   Author: resteex
   Identifier: APT_Sample_GazaAPTGroup_ImplantBigBang_bin 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_APT_Sample_GazaAPTGroup_ImplantBigBang_bin {
	meta: 
		 description= "APT_Sample_GazaAPTGroup_ImplantBigBang_bin Group" 
		 author = "Resteex Generator" 
		 date = "2022-04-26_03-26-24" 
