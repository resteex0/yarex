...
/*
   YARA Rule Set
   Author: resteex
   Identifier: APT_Sample_Coinminers_TrojanminerWin64_bin 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_APT_Sample_Coinminers_TrojanminerWin64_bin {
	meta: 
		 description= "APT_Sample_Coinminers_TrojanminerWin64_bin Group" 
		 author = "Resteex Generator" 
		 date = "2022-04-26_03-24-14" 
