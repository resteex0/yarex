...
/*
   YARA Rule Set
   Author: resteex
   Identifier: APT_Sample_KRKeMaIts_exe__exe 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_APT_Sample_KRKeMaIts_exe__exe {
	meta: 
		 description= "APT_Sample_KRKeMaIts_exe__exe Group" 
		 author = "Resteex Generator" 
		 date = "2022-03-29_06-36-42" 
