...
/*
   YARA Rule Set
   Author: resteex
   Identifier: APT_Sample_GamaredonGroup_PteranodonImplant7_bin 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_APT_Sample_GamaredonGroup_PteranodonImplant7_bin {
	meta: 
		 description= "APT_Sample_GamaredonGroup_PteranodonImplant7_bin Group" 
		 author = "Resteex Generator" 
		 date = "2022-04-26_03-20-17" 
