...
/*
   YARA Rule Set
   Author: resteex
   Identifier: theZoo_Win32_FamousSparrow 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_theZoo_Win32_FamousSparrow {
	meta: 
		 description= "theZoo_Win32_FamousSparrow Group" 
		 author = "Resteex Generator" 
		 date = "2022-01-20_21-36-31" 
	...
	strings:
		 ...
		 $a1= "SoftwareK7 ComputingK7TotalSecurityCommonInfoLogHandlers" fullword ascii
