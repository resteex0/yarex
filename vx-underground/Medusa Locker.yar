...
/*
   YARA Rule Set
   Author: resteex
   Identifier: vx_underground2_Medusa_Locker 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_vx_underground2_Medusa_Locker {
	meta: 
		 description= "vx_underground2_Medusa_Locker Group" 
		 author = "Resteex Generator" 
		 date = "2022-01-20_22-11-30" 
	...
	strings:
		 ...
		 $hex11= {2473313d20227b3837}
		 $hex12= {247332303d20226d69}
		 $hex13= {247332313d20225265}
		 $hex14= {247332323d2022534f}
		 $hex15= {247332333d2022536f}
