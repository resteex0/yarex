...
/*
   YARA Rule Set
   Author: resteex
   Identifier: Powersniff 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_Powersniff {
	meta: 
		 description= "Powersniff Group" 
		 author = "Resteex Generator" 
		 date = "2022-01-15_00-16-43" 
	...
	strings:
		 ...
		 $a1= "ff,rp*b*eC*_23a,v*J:*2i,,z*v,p*g,bbe**.,\\*:f*,gz*tzavj" fullword ascii
		 $a2= "*ff**rpbe*C_2,3a*v,J:*2izvp*g*b*be**.,*:fgzt,*zav*j" fullword ascii
		 $a3= "*G{2DF8D04C-5BFA-101B-BDE5-00AA0044DE52}#2.5#0#C:Prodir" fullword ascii
		 $a4= "VGqyOzPjXsBcZtFbSmauwdEUCgovTnYlkhpeiLDxWJIHQKfrAR" fullword ascii

		 $hex1= {2461313d202266662c}
		 $hex2= {2461323d20222a6666}
		 $hex3= {2461333d20222a477b}
		 $hex4= {2461343d2022564771}
		 $hex5= {247331303d20226562}
		 $hex6= {247331313d20226547}
		 $hex7= {247331323d20226573}
		 $hex8= {247331333d20226554}
		 $hex9= {247331343d20226666}
		 $hex10= {247331353d20222a66}
		 $hex11= {247331363d20222a47}
		 $hex12= {247331373d20222a47}
		 $hex13= {247331383d2022474f}
		 $hex14= {247331393d2022684d}
		 $hex15= {2473313d20222c3269}
		 ...
		 $hex22= {247332363d2022696d}
		 $hex23= {247332373d20224955}
		 $hex24= {247332383d20224955}
		 $hex25= {247332393d20226a71}
		 $hex26= {2473323d202232692c}
		 $hex27= {247333303d20226a72}
		 $hex28= {247333313d20224b6a}
		 $hex29= {247333323d20224b72}
		 $hex30= {247333333d20226b53}
		 $hex31= {247333343d20224b75}
		 $hex32= {247333353d20224d64}
		 $hex33= {247333363d20226d69}
		 $hex34= {247333373d20226f4b}
		 $hex35= {247333383d20225072}
		 $hex36= {247333393d20225076}
		 $hex37= {2473333d202241685a}
		 $hex38= {247334303d20227248}
		 $hex39= {247334313d2022527a}
		 $hex40= {247334323d20225469}
		 $hex41= {247334333d20227453}
		 $hex42= {247334343d20225647}
		 $hex43= {247334353d20227672}
		 $hex44= {247334363d20225767}
		 $hex45= {247334373d20227774}
		 $hex46= {247334383d20227873}
		 $hex47= {247334393d20225a62}
		 $hex48= {2473343d2022634757}
		 $hex49= {2473353d20222c632c}
		 $hex50= {2473363d202263682c}
		 $hex51= {2473373d2022433a55}
		 $hex52= {2473383d2022446f63}
		 $hex53= {2473393d2022646f77}
