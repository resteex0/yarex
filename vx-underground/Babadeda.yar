...
/*
   YARA Rule Set
   Author: resteex
   Identifier: vx_underground2_Babadeda 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_vx_underground2_Babadeda {
	meta: 
		 description= "vx_underground2_Babadeda Group" 
		 author = "Resteex Generator" 
		 date = "2022-01-20_21-50-30" 
	...
	strings:
		 ...
		 $a1= "@@B@DDF@HHJHLLN@PPRPTTVPXXZX\\^@``b`ddf`hhjhlln`pprpttvpxxzx||~" fullword ascii
		 $a2= "Blk=%d:Row=%d:%c:p_iqr=%g:g_iqr=%g:dm_p_iqr=%g:dm_g_iqr=%g:%c:" fullword ascii

		 $hex1= {2461313d2022404042}
		 $hex2= {2461323d2022426c6b}
		 ...
		 $hex11= {247331383d20225f5f}
		 $hex12= {247331393d20226578}
		 $hex13= {2473313d2022212429}
		 $hex14= {247332303d20226578}
		 $hex15= {247332313d20226d69}
		 $hex16= {247332323d20225344}
		 $hex17= {247332333d20225344}
		 $hex18= {247332343d2022534f}
		 $hex19= {247332353d20227370}
		 $hex20= {247332363d20227d7b}
