...
/*
   YARA Rule Set
   Author: resteex
   Identifier: vx_underground2_MacOS_KeRanger 
   /
/* Rule Set ----------------------------------------------------------------- */

rule resteex_vx_underground2_MacOS_KeRanger {
	meta: 
		 description= "vx_underground2_MacOS_KeRanger Group" 
		 author = "Resteex Generator" 
		 date = "2022-01-20_22-10-03" 
